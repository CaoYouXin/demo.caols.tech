...
export class OrderChartComponent implements OnInit {
  ...
  constructor(private dtaf: DomTreeAttrFixer) {}
  ...
  private changeYAxis(yAxisGen: Function) {
    ...
    setTimeout(() => this.dtaf.tt(yAxis.node()), 3000);
  ...
  ngOnInit() {
    ...
    d3.csv("assets/data/order-chart-data.csv", function (error, data) {
